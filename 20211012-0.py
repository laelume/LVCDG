...
b1 >> jbass([0, _, -4, -6], dur=4, amplify=0.6)


p1 >> ambi([0,7,14,12,7,4,2,0], slide=0.3, slidedelay=0.3, blur=3, spin=1, room=5, amplify=0.4).stop()

p2 >> space([7,6,5,4,3,2,1,0], swell=4,dur=1/16,vib=5, vibdepth=0.05, pan=PSine(43.7), amplify=0.4).every(1,'mirror')

p3 >> blip([0,7,4,0,4,7,4,7], dur=2, echo=4/5, shape=0.5, decay=4, pan=0.8, room=5, amplify=0.05)

p4 >> pluck(a, swell=4,dur=1/16,vib=5, vibdepth=0.05, pan=PSine(100), amplify=0.1).every(1,'mirror')
